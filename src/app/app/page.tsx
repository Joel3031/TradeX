      ...
      <div className="fixed top-0 left-0 right-0 z-50 border-b border-border/40 bg-background/80 backdrop-blur-md shadow-sm">
        <div className="max-w-7xl mx-auto px-4 md:px-8 h-16 grid grid-cols-3 items-center">
          <div className="flex justify-start">
            <Link 
              href="/" 
              className="text-xs text-muted-foreground hover:text-emerald-500 transition-colors flex items-center gap-1 font-medium"
            >
              &larr; Marketing Site
            </Link>
          </div>
          <div className="flex justify-center">
            <Link href="/app" className="relative h-8 w-28 md:h-10 md:w-40 block">
              <Image
                src="/TradeX-logo.png"
                alt="TradeX"
                fill
